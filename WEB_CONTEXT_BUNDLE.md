...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-fa3dd4b505420366"
    ],
    "allowed_axioms": [
    ...
    "domain": {
      "description": "Draft source observation in Graph theory, Graph coloring and labeling; domain extraction is unresolved.",
      "objects": [
    ...
    "problem_id": "problem:wikipedia-fa3dd4b505420366",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-fa3dd4b505420366",
        "url": "https://en.wikipedia.org/wiki/Total_coloring_conjecture"
      }
    ],
    "statement": {
      "language": "en",
      "text": "The total coloring conjecture of Behzad and Vizing that the total chromatic number is at most two plus the maximum degree",
      "version": 1
    },
    "title": "total coloring conjecture",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "a00846ab0e4c72ba21b01a96acccef85edec622acc352fe2f2c962bfcc8fc2ca"
}
```
